...
return array (
  ...
  'Base path "{path}" is not a valid directory.' => 'La ruta base "{path}" no es un directorio v�lido',
  ...
  'The module path "{path}" is not a valid directory.' => 'La ruta del módulo "{path}" no es un directorio v�lido.',
  ...
  '{attribute} "{value}" is invalid.' => '{attribute} "{value}" es inv�lido.',
  ...
  'The column "{column}" is not a foreign key in table "{table}".' => 'La columna "{column}" no es una llave for�nea en la tabla "{table}"',
  ...
  '"{path}" is not a valid directory.' => '"{path}" no es un directorio v�lido.',
  '&lt; Previous' => '&lt; Anterior',
  '&lt;&lt; First' => '&lt;&lt; Primero',
  'Active Record requires a "db" CDbConnection application component.' => 'Active Record requiere un componente de aplicaci�n "db" del tipo CDbConnection.',
  'Active record "{class}" has an invalid configuration for relation "{relation}". It must specify the relation type, the related active record class and the foreign key.' => 'Active record "{class}" contiene una configuraci�n de relaci�n inv�lida "{relation}". La misma debe especificar el tipo de relación, la clase active record relacionada y la clave foranea.',
  ...
  'Application runtime path "{path}" is not valid. Please make sure it is a directory writable by the Web server process.' => 'Ruta de runtime de aplicaci�n "{path}" es inválida. Verifique que sea un directorio con permisos de escritura por el proceso que corre el servidor Web.',
  ...
  'CCacheHttpSession.cacheID is invalid. Please make sure "{id}" refers to a valid cache application component.' => 'CCacheHttpSession.cacheID es inválido. Asegurese que "{id}" refiere a un componente de aplicaci�n de cache v�lido.',
  'CCaptchaValidator.action "{id}" is invalid. Unable to find such an action in the current controller.' => 'CCaptchaValidator.action "{id}" es inválido. No se h� podido encontrar dicha acci�n en el controlador actual.',
  'CDbAuthManager.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.' => 'CDbAuthManager.connectionID "{id}" es inválido. Asegurese que se refiere a un ID de un componente de aplicaci�n CDbConnection.',
  'CDbCache.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.' => 'CDbCache.connectionID "{id}" es inválido. Asegurese que refiera a un ID de un componente de aplicaci�n CDbConnection.',
  ...
  'Get a new code' => 'Obtenga un nuevo c�digo',
  'Go to page: ' => 'Ir a p�gina: ',
  ...
  'Login Required' => 'Iniciar sesi�n requerido.',
  ...
  'The system is unable to find the requested action "{action}".' => 'El sistema no ha podido encontrar la acci�n "{action}" solicitada.',
  'The system view path "{path}" is not a valid directory.' => 'La ruta de vistas de sistema "{path}" no es un directorio v�lido.',
  ...
  '{attribute} cannot be blank.' => '{attribute} no puede ser vac&iacute;o.',
