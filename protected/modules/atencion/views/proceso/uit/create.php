...
<div class="row">
    <div class="span9">
        ...
        <label style="font-style: italic">Seguimiento Req. <3 UIT</label>
    </div>
    <div class="span2">
        <br/>
        <h5>      
...
<br/>    
<?php $this->renderPartial('_form', array('tramite'=>$tramite,'uit'=>$uit,'persona'=>$persona,'proveedor'=>$proveedor, 'proveedoruit'=>$proveedoruit)); ?>
<div class="row">
